...
namespace sampledb {
    ...
    public partial class SampleDbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProjectDataTable : global::System.Data.TypedTableBase<ProjectRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProjectRow AddProjectRow(string Number, string ProjectName, double Budget) {
            ...
            private void InitClass() {
                ...
                this.columnProjectName.MaxLength = 15;
            }
...
namespace sampledb.SampleDbDataSet2TableAdapters {
    ...
    public partial class ProjectTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Project] WHERE (([Number] = @Original_Number) AND ([ProjectNam" +
                "e] = @Original_ProjectName) AND ((@IsNull_Budget = 1 AND [Budget] IS NULL) OR ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Project] ([Number], [ProjectName], [Budget]) VALUES (@Number, " +
                "@ProjectName, @Budget);\r\nSELECT Number, ProjectName, Budget FROM Project WHERE (" +
                "Number = @Number)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Project] SET [Number] = @Number, [ProjectName] = @ProjectName, [Budget] = @Budget WHERE (([Number] = @Original_Number) AND ([ProjectName] = @Original_ProjectName) AND ((@IsNull_Budget = 1 AND [Budget] IS NULL) OR ([Budget] = @Original_Budget)));
SELECT Number, ProjectName, Budget FROM Project WHERE (Number = @Number)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Number, ProjectName, Budget FROM dbo.Project";
        ...
        public virtual int Fill(SampleDbDataSet2.ProjectDataTable dataTable) {
        ...
        public virtual SampleDbDataSet2.ProjectDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDbDataSet2.ProjectDataTable dataTable = new SampleDbDataSet2.ProjectDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDbDataSet2.ProjectDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Number, string Original_ProjectName, global::System.Nullable<double> Original_Budget) {
            ...
            if ((Original_Budget.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((double)(Original_Budget.Value));
            }
            else {
        ...
        public virtual int Insert(string Number, string ProjectName, global::System.Nullable<double> Budget) {
            if ((Number == null)) {
        ...
        public virtual int Update(string Number, string ProjectName, global::System.Nullable<double> Budget, string Original_Number, string Original_ProjectName, global::System.Nullable<double> Original_Budget) {
            if ((Number == null)) {
                throw new global::System.ArgumentNullException("Number");
            }
            else {
            ...
            if ((Original_Budget.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Original_Budget.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProjectName, global::System.Nullable<double> Budget, string Original_Number, string Original_ProjectName, global::System.Nullable<double> Original_Budget) {
            return this.Update(Original_Number, ProjectName, Budget, Original_Number, Original_ProjectName, Original_Budget);
        }
    }
